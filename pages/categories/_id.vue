        ...
        <div class="w-full lg:w-9/12">
          <div class="flex items-center justify-between">
            <ol class="list-reset flex text-grey-dark">
              ...
              <h1 class="text-xl font-mono font-bold text-gray-700 md:text-xl">
                <li class="mr-2">
                  <NuxtLink class="hover:text-gray-500" to="/categories">Categories</NuxtLink>
                </li>
              </h1>
              <h1>
                <li class="text-gray-700 mr-2 mt-1">
          ...
          <div class="mt-8">
            <div class="flex">
              ...
              <div v-else>
                <a @click="nextpagenew('art1')" style="cursor: pointer;" class="
                    shadow-md
                    px-3
                    py-2
                    mx-1
...
query custom{
  ...
  users{
    ...
    const features = all.data.data.featureds;
    ...
    return { items, categories, latest, count, users, features };
  },
  data() {
    return {
      items: [],
  ...
  categories(where: { name: "${this.$route.params.id}"}){
    name,
    descriptionofcategory,
    blog(limit: ${this.limit}, start: ${this.currentpage * this.limit - this.limit
            }, sort: "Title:asc"){
      id,
      Title,
      Date,
